...
# save_path = './dataset/Inshop_Objectoccluded/'
save_path = './dataset/Inshop_Handoccluded/'
if not os.path.exists(save_path):
    os.makedirs(save_path)

img_save_path = './dataset/Inshop_Handoccluded/hand_occluded_img/'
if not os.path.exists(img_save_path):
    os.makedirs(img_save_path)

mask_save_path = './dataset/Inshop_Handoccluded/hand_occluded_mask/'
                ...
                for i in ids:
                    ...
                    if os.path.isdir(img):
                        ...
                        for name in imgs:
                            ...
                            resize_scale = random.uniform(0.2, 0.5)
                            ...
                            init_x, init_y = random.randint(0,70), random.randint(30,60)
                            ...
                            cv2.imwrite(new_mask_name, final_canvas)
