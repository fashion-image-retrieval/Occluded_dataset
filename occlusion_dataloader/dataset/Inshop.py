...
class Inshop_Dataset(torch.utils.data.Dataset):
    def __init__(self, root, mode, transform = None, occlusion=False):
        self.root = root
        self.mode = mode
    ...
    def make_occlusion(self, im):
        # further occlusion test can be written here
        rand1 = torch.randint(80, 100, (1,))
        rand2 = torch.randint(140, 160, (1,))
        im[:, rand1:rand2, rand1:rand2] = 0
        return im
